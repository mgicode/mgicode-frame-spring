...
import com.kuiren.common.annotation.MappingEntity;
import com.kuiren.common.annotation.MappingId;
/**
 * @author:pengrk
...
public class JdbcUtil {
	 ...
	 * @return
	 */
	public static String findIdName(Object object) {
		String result = null;
		try {
	...
	public static String findIdMethod(Object object) {
		...
		Assert.notNull(result, object.getClass().getSimpleName() + "实体没有配置ID");
		return result;
	}
